sap.ui.define([
    ...
    return Controller.extend("sap.ui.demo.nav.controller.employee.UserCentricDocs", {
        onInit: function() {
            // set mock data
            this.oModel = new JSONModel(sap.ui.require.toUrl("sap/ui/demo/nav/model/UploadCollectionData.json"));
