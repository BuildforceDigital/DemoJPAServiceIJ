sap.ui.define([
	...
	return Controller.extend("nl.buildforce.gt.controller.BaseController", {

		myDateFormatter: function(iDate) {
			return ((iDate) ? new Date(Number.parseInt(iDate) * 1000).toISOString().slice(0, 10) : null)
		},
		...
		onNavBack: function() {
			...
			if (sPreviousHash !== undefined) {
				...
				this.getRouter().navTo("system", {}, true);
			}
		},
