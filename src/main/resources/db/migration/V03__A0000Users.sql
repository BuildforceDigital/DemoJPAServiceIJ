...
create table DEV_GREENTRAK00.A0000USERS (
                                       ID               BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 10 INCREMENT BY 1) NOT NULL,
                                       "BirthDay"         varchar(36),
...
INSERT INTO DEV_GREENTRAK00.A0000USERS VALUES (6, 'Bd', 'Be', 'Csnr', 'TestActor05', 'M', 'Jf', 'lp', 'mp', 'nat', 'Jan',    'pe', '2020-05-01', 'us', null);
